...
exports.handleUnstructuredData = async (filePath) => {
  try {
    // Read CSV, convert to text
    const textFilePath = await fileUtils.extractTextFromFilesInFolder(filePath);
    ...
    console.error("Error handling unstructured data:", error);
  }
};
